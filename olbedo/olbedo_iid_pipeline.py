...
class OlbedoIIDOutput:
    """Output class for Olbedo Intrinsic Image Decomposition pipelines."""
...
class OlbedoIIDPipeline(DiffusionPipeline):
    """
    Pipeline for Olbedo Intrinsic Image Decomposition (IID).
    ...
    def __call__(
        ...
        Returns:
            `OlbedoIIDOutput`: Output class for Olbedo Intrinsic Image Decomposition prediction pipeline.
        """
        ...
        # Create output
        output = OlbedoIIDOutput(target_names=self.target_names)
